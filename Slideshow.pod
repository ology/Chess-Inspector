...
I could very well append JSON and use javascript or d3 to render things.
...
<img src="../site_root/img/White-to-move.png" style="float:right; vertical-align:top"/>

=end html

It's the start of the match and White is to move...

=head1 Move Number Three

=begin html

<img src="../site_root/img/Black-to-move.png" style="float:right; vertical-align:top"/>
...
=item Blue - Cell threatened

=item Green - Piece protected

=item Yello - Piece threatened
